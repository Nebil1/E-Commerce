...
namespace E_Commerce.Migrations
{
    ...
    [Migration("20220624135636_AddUpdatesToDb")]
    partial class AddUpdatesToDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Models.OrderType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Models.OrderDetail", b =>
                {
                    b.HasOne("E_Commerce.Models.OrderType", "OrderType")
                        .WithMany()
            ...
            modelBuilder.Entity("E_Commerce.Models.ShoppingCart", b =>
                {
                    b.HasOne("E_Commerce.Models.ApplicationUser", "ApplictionUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
